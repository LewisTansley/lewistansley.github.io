    ...
    e.exports = function(e) {
        return function(t, n, a) {
            ...
            if (e && n != n) {
                ...
                for (; l > p; p++)
                    if ((e || p in c) && c[p] === n) return e || p || 0; return !e && -1
        }
    }
}, function(e, t, n) {
    var o = n(35),
        ...
        c = function(e, t, n) {
            ...
            l.initialize = function() {
                l.logError = r.withModule(s), o(function() {
                    t = t || e.document.body, l.observe(), l.collectWidgets(t), l.boot()
                })
            }, l.facade = function() {
                return new a(l)
                ...
                e[r] = function(n) {
                    e[r] = void 0, e.document.head.removeChild(s), n.status || l.logError("Boot failed because " + n.reason, n.data), p = Object.assign({}, p, n.data.widgets), l.loadAssets(n.data.assets), f.forEach(l.initWidget.bind(l)), t && t()
                };
                var a = n || u;
                if (a.length) {
                    ...
                    s.src = o + "?" + c, e.document.head.appendChild(s)
                }
            }, l.revise = function() {
